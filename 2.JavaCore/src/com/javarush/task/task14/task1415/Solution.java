...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for (Apartment s : apartments){
            if (s instanceof Apt1Room) ((Apt1Room) s).clean1Room();
            else if (s instanceof Apt2Room) ((Apt2Room) s).clean2Rooms();
            else if (s instanceof Apt3Room) ((Apt3Room) s).clean3Rooms();
        }
    }
